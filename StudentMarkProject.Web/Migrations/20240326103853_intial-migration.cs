        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentMarkId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_StudentMarks_StudentMarkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_StudentMarks_StudentMarkId",
                        column: x => x.StudentMarkId,
                        principalTable: "StudentMarks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_StudentMarks_StudentMarkId",
                        column: x => x.StudentMarkId,
                        principalTable: "StudentMarks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_StudentMarkId",
                table: "Students",
                column: "StudentMarkId");

            migrationBuilder.CreateIndex(
                name: "IX_Subjects_StudentMarkId",
                table: "Subjects",
                column: "StudentMarkId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_StudentMarkId",
                table: "Teachers",
                column: "StudentMarkId");
        }
